...
%                                     2         2
%       cmask(y+hy, x+hx) = N * exp(-r /(E*sigma )) * cos(x' * omega)
%                                     2         2
%       smask(y+hy, x+hx) = N * exp(-r /(E*sigma )) * sin(x' * omega)
%   where
%        2       2    2
%       r  =  E*x  + y
...
% David Young, COGS, University of Sussex, January 2002
...
% Main computations
g = exp(k * (E*x.*x + y.*y));     % Gaussian mask
...
% Remove mean and make the sum equal 1
